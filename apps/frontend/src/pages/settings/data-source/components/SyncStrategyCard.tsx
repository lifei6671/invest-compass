  ...
  return (
    <section className="settings-basic-card settings-basic-mini-card settings-data-source-card">
      ...
      <div className="settings-data-source-kv-list">
        <KeyValue label="已启用任务" value={props.value.enabledJobsText} />
        <KeyValue label="排队 / 运行" value={props.value.activeRunsText} />
        <KeyValue label="失败任务" value={props.value.failedRunsText} />
        <KeyValue label="状态来源" value={props.value.sourceText} />
      </div>
